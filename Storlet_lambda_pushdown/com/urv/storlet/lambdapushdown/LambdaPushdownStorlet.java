...
public class LambdaPushdownStorlet implements IStorlet {
	...
	protected Stream writeYourLambdas(Stream<String> stream) {
        ...
        logger.emitLog("(OpenStack Storlets) Compilation time: " + (System.currentTimeMillis()-iniCompileTime) + "ms");
        System.out.println("(OpenStack Storlets) Compilation time: " + (System.currentTimeMillis()-iniCompileTime) + "ms");
